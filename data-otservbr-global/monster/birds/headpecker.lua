...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 47, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -450, effect = CONST_ME_YELLOWSMOKE, target = true},
	{name ="combat", interval = 2000, chance = 31, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -450, radius = 4, effect = CONST_ME_DRAWBLOOD, target = false},
}

...
monster.loot = {
	...
	{name = "Nighthunter Wing", chance = 14370, minCount = 1, maxCount = 2},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -360, maxDamage = -460, range = 7, radius = 3, effect = CONST_ME_ENERGYAREA, target = true}
}

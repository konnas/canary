...
monster.loot = {
	...
	{name = "titanium token", chance = 1540, maxCount = 3}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -401},
	{name ="combat", interval = 2300, chance = 47, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -460, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 3000, chance = 31, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -555, radius = 4, effect = CONST_ME_HITBYPOISON, target = false},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -380, maxDamage = -450, length = 8, spread = 3, effect = CONST_ME_ROOTS, target = false}
}

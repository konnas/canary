...
monster.loot = {
	...
	{name = "wand of starstorm", chance = 14560},
	{id = 33934, chance = 15400}, -- telescope eye
	{name = "violet gem", chance = 14560},
	{name = "lightning headband", chance = 11920},
	{name = "green gem", chance = 14560},
	{name = "blue gem", chance = 14560},
	{name = "wand of inferno", chance = 9200},
	{name = "wand of voodoo", chance = 12200},
	{name = "wand of defiance", chance = 10000},
...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -200, maxDamage = -300, range = 7, shootEffect = CONST_ANI_ENERGY, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -200, maxDamage = -350, radius = 4, effect = CONST_ME_ENERGYHIT, target = false},
	{name ="combat", interval = 2000, chance = 14, type = COMBAT_HOLYDAMAGE, minDamage = -300, maxDamage = -350, range = 7, shootEffect = CONST_ANI_SPECTRALBOLT, effect = CONST_ME_HOLYDAMAGE, target = true},

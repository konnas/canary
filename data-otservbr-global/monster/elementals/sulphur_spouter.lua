...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 47, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -450, range = 4, shootEffect = CONST_ANI_HOLY, effect = CONST_ME_YELLOW_RINGS, target = true},
	{name ="combat", interval = 1000, chance = 31, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -450, radius = 4, effect = CONST_ME_YELLOWSMOKE, target = true},
}

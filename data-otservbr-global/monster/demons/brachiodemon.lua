...
monster.loot = {
	...
	{name = "fire axe", chance = 9500},
	{name = "royal helmet", chance = 5500},
	{name = "mastermind shield", chance = 4000},
	{name = "assassin dagger", chance = 5500},
	{name = "butcher's axe", chance = 5500},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -400, range = 7, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true},
	{name ="combat", interval = 2000, chance = 18, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -400, radius = 3, effect = CONST_ME_FIREAREA, target = false},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_DEATHDAMAGE, minDamage = -350, maxDamage = -400, radius = 4, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 2000, chance = 24, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -400, radius = 4, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -500, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false},
}

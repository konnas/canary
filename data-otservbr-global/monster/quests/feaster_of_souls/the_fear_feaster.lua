...
monster.loot = {
	...
	{name = "ghost chestplate", chance = 550},
	{name = "spooky hood", chance = 550}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -600, condition = {type = CONDITION_POISON, totalDamage = 4, interval = 4000}},
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_LIFEDRAIN, minDamage = -300, maxDamage = -700, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="combat", interval = 1000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -750, radius = 2, shootEffect = CONST_ANI_SMALLEARTH, target = false},
	...
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -600, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
...
monster.defenses = {
	...
	{name ="combat", interval = 10000, chance = 40, type = COMBAT_HEALING, minDamage = 700, maxDamage = 1500, effect = CONST_ME_MAGIC_BLUE, target = false}
}

...
monster.loot = {
	...
	{name = "spooky hood", chance = 750},
	{name = "fabulous legs", chance = 750},
	{name = "soulful legs", chance = 1000}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -650, condition = {type = CONDITION_POISON, totalDamage = 4, interval = 4000}},
	{name ="combat", interval = 2000, chance = 100, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -600, effect = CONST_ME_MAGIC_RED, target = true},

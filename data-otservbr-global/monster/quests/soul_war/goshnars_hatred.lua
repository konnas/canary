...
monster.loot = {
	...
	{name = "figurine of hatred", chance = 2000}, 
	{name = "spectral horseshoe", chance = 2000},
	{name = "spectral horse tack", chance = 2000},
	{name = "bracelet of strengthening", chance = 2000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -1000, length = 8, spread = 3, effect = CONST_ME_GROUNDSHAKER, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -700, maxDamage = -1000, range = 6, effect = CONST_ME_ENERGYHIT, target = true}
}

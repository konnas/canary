...
monster.loot = {
	...
	{name = "figurine of cruelty", chance = 2400},
	{name = "figurine of hatred", chance = 2400},
	{name = "figurine of greed", chance = 2400},
	{name = "figurine of spite", chance = 2400},
	{name = "figurine of megalomania", chance = 2400},
	{name = "megalomania's skull", chance = 2400},
	{name = "megalomania's essence", chance = 2400},
	{name = "platinum token", chance = 84000, minCount = 7, maxCount = 35},
	{name = "bag you desire", chance = 1200}
}
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -1000, maxDamage = -1200, length = 8, spread = 3, effect = CONST_ME_INSECTS, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -800, maxDamage = -1000, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -900, length = 10, spread = 0, effect = CONST_ME_BLUE_GHOST, target = false},
}

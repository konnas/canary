...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -50, length = 8, spread = 3, effect = CONST_ME_FIREATTACK, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -30, length = 8, spread = 3, effect = CONST_ME_MORTAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -95, radius = 3, effect = CONST_ME_HITBYFIRE, target = false}
}

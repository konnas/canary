...
monster.loot = {
	...
	{name = "figurine of cruelty", chance = 2000},
	{name = "spectral saddle", chance = 2000},
	{name = "spectral horse tack", chance = 2000},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -400, maxDamage = -800, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -500, maxDamage = -600, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -700, maxDamage = -1000, range = 7, radius = 4, shootEffect = CONST_ANI_EXPLOSION, effect = CONST_ME_DRAWBLOOD, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -1000, radius = 3, effect = CONST_ME_GROUNDSHAKER, target = false}
}

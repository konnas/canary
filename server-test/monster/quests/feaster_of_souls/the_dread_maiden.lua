...
monster.attacks = {
	...
	{name ="combat", interval = 4000, chance = 50, type = COMBAT_DEATHDAMAGE, minDamage = -300, maxDamage = -600, length = 7, effect = CONST_ME_POFF, target = false},
	{name ="dread rcircle", interval = 2000, chance = 40, minDamage = -400, maxDamage = -700}
}
...
monster.defenses = {
	...
	{name ="combat", interval = 10000, chance = 40, type = COMBAT_HEALING, minDamage = 750, maxDamage = 1500, effect = CONST_ME_MAGIC_BLUE, target = false}
}

...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -160, range = 7, shootEffect = CONST_ANI_SMALLEARTH, effect = CONST_ME_STONES, target = true},
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -160, length = 5, spread = 3, effect = CONST_ME_STONES, target = false}
}

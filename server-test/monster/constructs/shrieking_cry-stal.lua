...
monster.attacks = {
	...
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -400, length = 7, spread = 0, effect = CONST_ME_PINK_ENERGY_SPARK, target = false},
	{name ="combat", interval = 3000, chance = 45, type = COMBAT_PHYSICALDAMAGE, minDamage = -350, maxDamage = -550, length = 6, spread = 1, effect = CONST_ME_SOUND_PURPLE, target = false},
}
